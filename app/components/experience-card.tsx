...
const experiences: Experience[] = [
  {
    ...
    from: "2025",
    to: "present",
    description: "Developer team focused on building public open-source projects and delivering custom commission work.",
  },
  {
      ...
      <div className="py-8">
        <div className="flex flex-col gap-8 border-l border-secondary-500 px-8 max-sm:px-1 max-[400px]:border-l-0">
          {sortedExperiences.map((exp, index) => {
            const showYear = index === 0 || exp.from !== sortedExperiences[index - 1].from;
